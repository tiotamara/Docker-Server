				...
				if($fd_kul > 0)
				{
					...
					while ($m = mysql_fetch_assoc($sql_kul)) {
						echo"<tr>
							...
							<td>$m[nomor_telp]</td>
							<td>$m[alamat]</td>
							<td><a href='med.php?mod=pelanggan&act=form&id=$m[kode_pelanggan]'><i class='fa fa-pencil-square w3-large w3-text-blue'></i></a> 
							<a href='$aksi?mod=pelanggan&act=hapus&id=$m[kode_pelanggan]' onclick=\"return confirm('Yakin hapus data');\"><i class='fa fa-trash w3-large w3-text-red'></i></a></td>
